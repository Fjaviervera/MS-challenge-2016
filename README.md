...
To use this software you need the followings pyton package.
...
The easiest way to install them is using Conda wich install most of the package and then use pip to install Medpy, Sklearn, Pickle and xlsxwriter.
